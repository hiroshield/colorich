...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.only(top: 5, left: 5, bottom: 100, right: 5),
  ...
  void scrollToTop() {
    final topOffset = _scrollController.position.minScrollExtent;
    _scrollController.animateTo(
      topOffset,
      duration: Duration(milliseconds: scrollDuration),
      curve: scrollCurves,
...
List<Onepiece> puzzuleList = [
  ...
  Onepiece(Colors.yellow),
  Onepiece(Colors.blue),
  Onepiece(Colors.pinkAccent),
  Onepiece(Colors.cyan),
  Onepiece(Colors.blueAccent),
  Onepiece(Colors.orangeAccent),
  ...
  Onepiece(Colors.yellow),
  Onepiece(Colors.blue),
  Onepiece(Colors.orange),
  Onepiece(Colors.brown),
  Onepiece(Colors.green),
  Onepiece(Colors.grey),
  Onepiece(Colors.pink),
  Onepiece(Colors.teal),
  Onepiece(Colors.amber),
  Onepiece(Colors.indigo),
